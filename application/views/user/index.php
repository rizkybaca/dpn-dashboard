							...
							<div class="tab-pane fade profile-edit pt-3" id="profile-edit">
								<form action="<?= base_url('user/edit'); ?>" method="POST"
									...
									<div class="row mb-3">
										...
										<div class="col-md-8 col-lg-9">
											<img src="<?= base_url('assets/img/profile/') . $user['image']; ?>"
												alt="Profile" />
											<div class="pt-2">
												<a href="#" class="btn btn-sm" title="Upload new profile image"
													style="background-color: #242790; color: white"><i
									...
									<div class="row mb-3">
										...
										<div class="col-md-8 col-lg-9">
											<textarea required name="about" class="form-control" id="about"
												style="height: 100px"><?= $user['about'] ?></textarea>
										</div>
									</div>
									<div class="row mb-3">
										<label for="organization"
											class="col-md-4 col-lg-3 col-form-label">Organization</label>
										<div class="col-md-8 col-lg-9"><input required name="organization" type="text"
												class="form-control" id="organization"
												value="<?= $user['organization'] ?>" /></div>
									</div>
									<div class="row mb-3">
										<label for="job" class="col-md-4 col-lg-3 col-form-label">Job</label>
										<div class="col-md-8 col-lg-9"><input required name="job" type="text"
												class="form-control" id="job" value="<?= $user['job'] ?>" /></div>
									</div>

									<div class="text-center"><button type="submit" class="btn"
											style="background-color: #242790; color: white">Save Changes</button></div>
								</form>
							</div>
								...
								<form action="<?= base_url('user/changepassword'); ?>" method="POST">
									...
									<div class="text-center">
										<button type="submit" class="btn"
											style="background-color: #242790; color: white">Change Password</button>
									</div>
								</form>
							</div>
						</div>
