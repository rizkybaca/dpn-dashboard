...
<head>
	...
	<link rel="icon" href="<?= base_url('assets/assets_user/'); ?>/img/link_icon.png" type="image/x-icon" />
	...
	<!--  custom css file  -->
	<link rel="stylesheet" href="<?= base_url('assets/assets_user/'); ?>/css/user.css" />
			...
			<a class="navbar-brand " href="#"> <a class="navbar-brand" href="#"><img src="<?= base_url('assets/assets_user/') ?>/img/logo.png" style="width: 85px; height: 45px" alt="" /></a>
				...
				<div class="collapse navbar-collapse text-right" id="navbarText">
					<ul class="nav nav-tabs nav-tabs-bordered ms-auto mb-2 mb-lg-0">
						...
						<li class="nav-item ms-3" data-bs-toggle="tab">
							<a class="nav-link " href="<?= base_url("User_Program"); ?>">Program</a>
						</li>
						<li class="nav-item ms-3" data-bs-toggle="tab">
							<a class="nav-link " href="<?= base_url("User_Artikel"); ?>">Artikel</a>
						</li>
						<li class="nav-item ms-3" data-bs-toggle="tab">
							<a class="nav-link " href="<?= base_url("User_About"); ?>">Tentang Kami</a>
						</li>
					</ul>
				</div>
		</div>
