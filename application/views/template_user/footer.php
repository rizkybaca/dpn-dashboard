	...
	<div class="container text-center text-md-start ">
		...
		<div class="row mt-3">
			...
			<div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-3">
				...
				<p class="text-white" style="font-size:14px; margin-top:10px; ">Copyright. DPN. 2022. All right reserved</p>
			</div>
			<!-- Grid column -->
			...
			<div class="col-md-3 col-lg-3 col-xl-3 mx-auto  text-white mb-3">
				...
				<p style="font-size:14px; "><i class="fa-solid fa-location-dot"> </i> &nbsp;&nbsp;Jln. Bahagia No. 2, Kel. Sudiang, Kec. Biringkanaya, Kota Makassar, Sulawesi Selatan, Indonesia.</p>
				<p style="font-size:14px; "><i class="fa-solid fa-phone"></i> &nbsp;&nbsp;0812-3421-3319</p>
				<p style="font-size:14px; "><i class="fa-solid fa-envelope"></i> &nbsp;&nbsp;halo@dedikasipemudanegeri.id</p>
			</div>
			<!-- Grid column -->
			...
			<div class="col-md-1 col-lg-1 col-xl-1 mx-auto  text-white text-center mb-3">
				...
				<p style="font-size:14px; ">
					<a href="<?= base_url("user/Program"); ?>" class="text-reset">Program</a>
				</p>
				<p style="font-size:14px; ">
					<a href="<?= base_url("user/Artikel"); ?>" class="text-reset">Artikel</a>
				</p>
				<p style="font-size:14px; ">
					<a href="<?= base_url("user/About"); ?>" class="text-reset">Tentang Kami</a>
				</p>
			</div>
			<!-- Grid column -->
