<main id="main" class="main">
	<div class="pagetitle">
		...
		<p class="keterangan-judul">Anda dapat menambah, mengubah dan menghapus Tipe Program untuk digunakan saat
			mengelola Program</p>
	...
	<section class="section dashboard mt-4">
		<div class="card-artikel col-sm-11">
			<div class="card">
				<div class="card-header font-weight-bold text-gray-100" style="background-color: #eeeef0">List Tipe
					Program</div>
										...
										<td>
											<center>
												<a class="mb-2 mt-2 btn btn-sm"
													...
													href="<?= base_url('program/edit_program_type/') . $p['id_program_type'] ?>">
													Edit </a>
											</center>
										</td>
										<td>
											<center>
												<a onclick="return confirm('Yakin Hapus?')"
													...
													href="<?= base_url('program/delete_program_type/') . $p['id_program_type'] ?>">
													Hapus </a>
											</center>
										</td>
									</tr>
